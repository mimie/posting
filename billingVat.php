  ...
  <center>
    ...
    <div id="billedTo">
     <table align="left">
      ...
      <tr>
         <td width="42.71px"></td>
         <td width="485px"><font style="font-size:13px">Name (company name)</font></td>
         <td align="right" width="165px" style="border-right:2px solid black"><font style="font-size:13px"><b>BILLING NUMBER</b></font></td>
         <td width="195.78px"><font style="font-size:19px"><b>536524</b></font></td>
      </tr>
      <tr>
         <td></td>
      ...
      <tr>
         ...
         <td width="195.78px"><font style="font-size:13px">on or before date of event</font></td>
      </tr>
      <tr>
       <td colspan="4"><br></td>
      </tr>
    ...
    <div id="billedTo">
     ...
     <table align="left" style="border-collapse:collapse;">
      ...
      <tr>
        <td colspan="2" height="350px" style="border:2px solid black;"></td>
      ...
      <tr>
        ...
        <td width="195.78px" height="26.84px" style="border:2px solid black;"></td>
      </tr>
      <tr>
        <td width="195.78px" height="26.84px" style="border:2px solid black;"></td>
      </tr>
      <tr>
        ...
        <td width="195.78px" style="border:2px solid black;" rowspan="2"></td>
      </tr>
      <tr>
