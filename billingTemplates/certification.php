  ...
  <center>
    ...
    <div id="billedTo">
     <table align="left">
      <tr>
         ...
         <td width="329.95px"><font style="font-size:13px"><b>[Company Name]</b></font></td>
         <td width="135.31px" style="border-right:2px solid black;"><font style="font-size:13px"><b>DATE:</b></font></td>
         <td width="132.28px"><font style="font-size:13px">September 27, 2013</font></td>
      </tr>
      <tr>
         <td></td>
         <td><font style="font-size:13px">[Street Address]</font></td>
         <td style="border-right:2px solid black;"><font style="font-size:15px"><b>Billing No.:</b></font></td>
         <td><font style="font-size:13px"><b>[100]</b></font></td>
      </tr>
      <tr>
         <td></td>
         <td><font style="font-size:13px">[City, ST  ZIP Code]</font></td>
         <td style="border-right:2px solid black;"><font style="font-size:13px"><b>Member ID:</b></font></td>
         <td><font style="font-size:13px">[ABC12345]</font></td>
      </tr>
      <tr>
         <td></td>
    ...
    <div id="billedTo">
     ...
     <table align="left" style="border-collapse:collapse;" border="1px">
      ...
      <tr>
        <td colspan="2" height="350px" style="border:2px solid #BCF5A9;"></td>
        <td style="border:2px solid #BCF5A9;"></td> 
      </tr>
      <tr>
        ...
        <td width="132.28px" align="center"><font style="font-size:13px">0.0</font></td>
      </tr>
     </table>
     </div>
     ...
     <table align="left">
      <tr>
       ...
       <td width="419.61px">
          ...
          <font style="font-size:13px;font-family:Arial">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Acct No. 3564-0058-26</b></font><br>
